...
import { useCurriculumFindFirst, useRoqClient } from 'lib/roq';
...
function CurriculumViewPage() {
  ...
  const { data, error, isLoading } = useCurriculumFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('curriculum', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/curricula/edit/${id}`} passHref legacyBehavior>
                    <Button
