...
import { useRoqPlatformUserProfiles, useProposalCount, useContentCount, useReviewCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const proposalStat = useProposalCount();
